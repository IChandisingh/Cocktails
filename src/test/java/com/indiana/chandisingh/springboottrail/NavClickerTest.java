package com.indiana.chandisingh.springboottrail;// Generated by Selenium IDE
...
public class NavClickerTest {
  ...
  @Test
  public void navClicker() {
    driver.get("http://localhost:3000/");
    driver.manage().window().setSize(new Dimension(968, 579));
